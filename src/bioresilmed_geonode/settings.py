...
try:
    from bioresilmed_geonode.local_settings import *
...
# # afegeix 'ca' si no hi és, sense trencar la tupla existent
# if not any(code == 'ca' for code, __ in LANGUAGES):
#     LANGUAGES = LANGUAGES + (('ca', _('Català')),)

# # (opcional) per defecte en castellà o català; millor codi curt
# LANGUAGE_CODE = os.getenv('LANGUAGE_CODE', LANGUAGE_CODE).split('-')[0]


#
# General Django development settings
#
PROJECT_NAME = "bioresilmed_geonode"

# add trailing slash to site url. geoserver url will be relative to this
if not SITEURL.endswith("/"):
    SITEURL = "{}/".format(SITEURL)

SITENAME = os.getenv("SITENAME", "bioresilmed_geonode")
